...
// Run only if db does not exist already
// Delete db if you want new data to be populated
if (!fs.existsSync(resolve(__dirname, `../db/gupy-swapi-${env.toLowerCase()}.db`))) {
  ...
  console.log(`Database db/gupy-swapi-${env.toLowerCase()}.db already exists.\nNot generating seed.`)
}
